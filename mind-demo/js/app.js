                ...
                resultsContainer.innerHTML = `
                    <div style="padding: 24px; max-width: 900px; margin: 0 auto;">
                        <div style="margin-bottom: 24px;">
                            <h2 style="font-size: 24px; font-weight: 600; color: var(--text-primary); margin: 0 0 8px 0; display: flex; align-items: center; gap: 12px;">
                            ...
                            ${notes.map(note => `
                                <div class="tag-result-card" data-note-id="${note.id}" style="background: var(--bg-secondary); border: 1px solid var(--border); border-radius: 8px; padding: 16px; cursor: pointer; transition: all 0.2s;">
                                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                                        ...
                                        <span style="font-weight: 500; color: var(--text-primary);">${this.escapeHtml(note.title) || 'Untitled'}</span>
                                    </div>
